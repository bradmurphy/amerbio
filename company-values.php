<?php
  ...
  /* Template Name: Company Values Page */
...
<section class="company-values">
    ...
    <div class="section-hero">
      ...
      <div class="section-hero__content">
        ...
        <h1 class="section-hero__headline">Our Values</h1>
    ...
    <div class="site-section">
        ...
        <p class="site-copy site-copy--company">
        ...
        <div class="section-content">
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">People</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Sincerity</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Passion</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Commitment</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Knowledge</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Strength</p>
                <p class="site-copy">
            ...
            <div class="section-content__cell">
                <p class="site-copy site-copy--lrg site-copy--values">Merit</p>
                <p class="site-copy">
