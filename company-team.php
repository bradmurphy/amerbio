...
<section class="company-team">
    ...
    <div class="section-hero">
      ...
      <div class="section-hero__content">
        ...
        <h1 class="section-hero__headline">Our Team</h1>
        <div class="section-hero__divider"></div>

        <div class="section-hero__secondary">
            <p class="site-copy">
                ABO's well-rounded team is made up of seasoned entrepreneurs, expert physicians, and an internationally-renowned biomedical engineer.
            </p>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
        <div class="section-content section-content__team">
            ...
            <div class="section-main">
                <p class="site-copy site-copy--heading">
