...
<section class="company">
    ...
    <div class="section-hero">
      ...
      <div class="section-hero__content">
        <h1 class="section-hero__headline">The Company</h1>
      </div>
    </div>
    ...
    <div class="site-section">
        ...
        <h2 class="site-section__headline">About American BioOptics</h2>

        <div class="section-content">
            <div class="section-content__cell">
                <p class="site-copy">
                    American BioOptics (ABO) is a medical device company located in Chicago, Illinois. The company was founded in 2006 by a group of entrepreneurs, expert physicians in gastroenterology, and an internationally-renowned biomedical engineer with expertise in optical technologies.
                </p>
                <p class="site-copy">
