...
<section class="product-data">
    ...
    <div class="section-hero">
      ...
      <div class="section-hero__content">
        ...
        <h1 class="section-hero__headline">Clinical Trial Data</h1>
    ...
    <div class="site-section">
      ...
      <div class="section-content">
        <div class="section-content__cell">
            ...
            <div class="data-sensitivity">
              <p class="site-copy site-copy--lrg">Sensitivity <span>100%</span></p>
            </div>
            <div class="data-specificity">
              <p class="site-copy site-copy--lrg">Specificity	<span>64%</span></p>
            </div>
            <p class="site-copy">
    ...
    <div class="site-section site-section--lrg">
      ...
      <div class="section-content section-content--lrg">
      	<article class="section-content__article">
      		...
      		<a href="#" class="site-copy site-copy--link">DOWNLOAD PDF</a>
      	</article>
